  ...
  it('情境二：timeWindowEnd 早於 timeWindowStart 時回 400，且不建立任何紀錄', async () => {
    const req = makeReq({
      body: {
        ...
        timeWindowStart: '下午 6:00',
        timeWindowEnd: '上午 9:00',
      },
    })
    const res = makeRes()
  ...
  it('情境三：uniformTime.endTime 早於 startTime 時回 400，且不建立任何紀錄', async () => {
    const req = makeReq({
      body: {
        ...
        uniformTime: { startTime: '下午 6:00', endTime: '上午 9:00' },
      },
    })
    const res = makeRes()
  ...
  it('情境四：任一筆 dateSlots 的 endTime 早於自己的 startTime 時回 400，且不建立任何紀錄', async () => {
    const req = makeReq({
      body: {
        ...
        deadline: new Date(2099, 0, 1).toISOString(),
        dateSlots: [
          { date: '2099/01/02', startTime: '上午 9:00', endTime: '上午 10:00' },
          { date: '2099/01/03', startTime: '下午 6:00', endTime: '上午 9:00' },
        ],
      },
    })
    const res = makeRes()
