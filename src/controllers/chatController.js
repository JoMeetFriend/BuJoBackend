import { saveMessage, getMessages, verifyParticipant, getChatByActivityId } from '../services/chatService.js'
...
export async function createMessage(req, res) {
  ...
  if (content.length < 1 || content.length > 2000) {
    return res.status(400).json({ message: 'content 長度需在 1-2000 字元之間' })
  }
