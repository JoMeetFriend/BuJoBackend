# demo-calendar-activity-seeding Specification

## Purpose

TBD - created by archiving change 'expand-alice-calendar-demo-activities'. Update Purpose after archive.
...
<!-- @trace
source: expand-alice-calendar-demo-activities
updated: 2026-07-21
code:
  - prisma/seeds/activities.js
tests:
  - src/__tests__/seedActivities.test.js
-->
